-- ============================================
-- Phase 4: Harden create_reservation_atomic (server-side totals + deposit)
-- Created: 2026-02-07
-- Purpose: Prevent client-side tampering of rates/total/deposit
-- ============================================
...
BEGIN
  ...
  INTO v_has_pavilion, v_has_room, v_has_cottage
  FROM public.units u
  WHERE u.unit_id = ANY(p_unit_ids);

  v_deposit := CASE
    WHEN v_has_pavilion THEN 1000
