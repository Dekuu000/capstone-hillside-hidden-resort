-- Align stay total computation with pax-priced units used by guest booking UI/API.
-- Fixes false "Invalid total amount" when units have dynamic pricing by guest count.
