...
export function SearchNav({ isAuthed = false, isAdmin = false }: SearchNavProps) {
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--color-border)] bg-[var(--color-surface)]/95 backdrop-blur">
      <div
        className={`mx-auto flex h-[70px] w-full max-w-[1440px] items-center gap-3 px-4 md:h-20 md:justify-between md:px-6 lg:px-8 ${
          isAuthed ? "justify-center" : "justify-between"
        }`}
      >
