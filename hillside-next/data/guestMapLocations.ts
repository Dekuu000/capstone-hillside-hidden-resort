...
export const guestMapLocations: GuestMapAmenityPin[] = [
  ...
  {
    id: "spa",
    name: "Evergreen Pavilion",
    description: "Large event pavilion for 30-50 guests.",
    x: 74,
    y: 30,
    kind: "facility",
  },
  {
    id: "cottages",
    name: "Ridge Nest / Peace Haven / Calmstone Cabin",
    description: "Cottage cluster (small to large group capacity).",
    x: 35,
    y: 50,
    kind: "facility",
  },
  ...
  {
    id: "viewdeck",
    name: "Pinecrest Exclusive Zone",
    description: "Exclusive full-resort booking area.",
    x: 83,
    y: 48,
    kind: "trail",
  },
  {
    id: "hall",
    name: "Luxe Hideaway (Units 1-3)",
    description: "Room cluster with three available Luxe Hideaway units.",
    x: 21,
    y: 72,
    kind: "facility",
  },
